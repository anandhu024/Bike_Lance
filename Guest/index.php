...
?>
    ...
    <div class="hero-wrap ftco-degree-bg" style="background-image: url('https://www.returnofthecaferacers.com/wp-content/uploads/2019/06/thornton-hundred-panigale-1.jpg');" data-stellar-background-ratio="0.5">
    			...
    			<div class="col-md-12	featured-top">
    				<div class="row no-gutters">
	  					<div class="col-md-4 d-flex align-items-center">
	  						...
	  						<form action="http://localhost/Bike%20Lance/customer/bikeview.php" class="request-form ftco-animate bg-primary" method="POST">
		          		<h2>Make your trip</h2>
                  <h5 class="heading-section mb-4">Better Way to Rent Your Perfect Bikes</h5>
                  <div class="d-flex">
                    <!--
			    					<div class="form-group mr-2">
			                <label for="" class="label">Pick-up date</label>
			                <input type="text" class="form-control" name="pick_date">
			              </div>
                    <div class="form-group ml-2">
			                  <label for="" class="label">_________</label>
                 ...
                 <!-- <div class="d-flex"> 
			             <div class="form-group ml-2">
                          ...
                          <input type="text" class="form-control" name="off_date">
                        </div> 
                  </div>
                        ...
                        <span class="flaticon-key"></span></div>
					        ...
					        <p><a href="http://localhost/Bike%20Lance/Guest/customerlogin.php" class="btn btn-primary py-3 px-4">Reserve Your Perfect Bike</a></p>
                ...
                <div class="item"> 
                      ...
                      <div class="text">
                          ...
                          <div class="d-flex mb-3">
                            ...
                            <p class="d-flex mb-0 d-block"><a href="http://localhost/Bike%20Lance/Guest/customerlogin.php" class="btn btn-primary py-2 mr-1">Book now</a> <a href="bikedetails.php?bike_id=<?php echo $display1['bike_id']; ?>" class="btn theme_btn button_hover">Details</a></p>
                      </div>
		    				   </div> 
                </div>
                <?php
