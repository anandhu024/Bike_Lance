  ...
  ?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <h3 class="page-title"> Rent Report </h3>
            <form action="Excel\excel_rentreport.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">              
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <a href="C:\wamp\www\Bike Lance\Admin\Excel\excel_rentreport.php">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $s=1;
                        $sql=mysqli_query($con,"SELECT customer_name, `bike_requestdate` , bike_registrationnumber, bike_modelname
