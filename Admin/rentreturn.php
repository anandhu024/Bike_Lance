        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Rent Return </h3>
        ...
        <tr>
            ...
            <td> 
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropupMenuSplitButton2">
                          <a class="dropdown-item" href="rentreturnviewmore.php?rent_id=<?php echo $display["rent_id"];?>">View More</a> 
                        </div>
                      </div>
                             </td>
        </tr>
