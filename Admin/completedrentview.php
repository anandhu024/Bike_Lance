<?php
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Completed Rent</h3>
 ...
 <tbody>
        <?php
           ...
           $s=1;
           $sql=mysqli_query($con,"SELECT * FROM `tblbikelancerent` re 
           ...
           where re.rentstatus='Rent Completed'");
        ...
        <tr>
            ...
            <td> 
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropupMenuSplitButton2">
                          <a class="dropdown-item" href="completedrentviewmore.php?rent_id=<?php echo $display["rent_id"];?>">View More</a> 
                        </div>
                      </div>
                             </td>
        </tr>
