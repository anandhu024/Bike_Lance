          ...
          <div class="content-wrapper">
            ...
            <div class="row">              
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a href="acceptedrequestview.php">
        ...
        <tr>
            ...
            <td> 
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropupMenuSplitButton2">
                          <a class="dropdown-item" href="rentrequestviewmore.php?requestid=<?php echo $display["request_id"];?>">View More</a> 
                        </div>
                      </div>
                             </td>
        </tr>
