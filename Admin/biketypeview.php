<?php
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Bike Type Details </h3>
 ...
 <tbody>
        ...
        <tr>
            ...
            <td><?php echo $display["bike_typediscription"] ?></td>
            <td> 
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropupMenuSplitButton2">
                          <a class="dropdown-item" href="biketypeedit.php?cid=<?php echo $display["type_id"];?>">Edit</a>
                          <a class="dropdown-item" onclick="return confirm('Are u sure?')" 
                           href="biketypedelete.php?typeid=<?php echo $display["type_id"]; ?>">Delete</a>
                        </div>
                      </div>
                             </td>
        </tr>
