...
$productResult = $db_handle->runQuery("SELECT customer_name, `bike_requestdate` , bike_modelname, `bike_requestfromdate` , `bike_purpose` , `bike_requesttodate`
